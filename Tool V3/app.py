"""
Risk of Measles Outbreak in US — App V3 Streamlit entrypoint (Tool V3/).
...
try:
    ...
    st.error("Something went wrong. Check the log file (e.g. Tool V3/dashboard.log) for details.")
    st.stop()

"""
Risk of Measles Outbreak in US — App V2 Streamlit entrypoint (Tool V2/).
...
try:
    ...
    st.error("Something went wrong. Check the log file (e.g. Tool V2/dashboard.log) for details.")
    st.stop()
